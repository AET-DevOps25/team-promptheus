...
public class SearchFilter {
  ...
  public static final List<String> SORTABLE_ATTRIBUTES = Arrays.asList("created_at_timestamp", "relevance_score");

  public static final List<String> TIMESTAMP_ATTRIBUTES = Arrays.asList("created_at_timestamp");

  public static final List<String> BOOLEAN_ATTRIBUTES = Arrays.asList("is_selected");
