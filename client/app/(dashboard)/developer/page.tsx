...
export default function DeveloperPage() {
	...
	const selectedCount = contributions.filter(
		(contrib) => contrib.isSelected,
	).length;
									...
									<Table>
										...
										<TableBody>
											{contributions.map((contribution) => {
												const typeKey =
													contribution.type.toLowerCase() as keyof typeof typeIcons;
												...
												return (
													<TableRow
														className={
															contribution.isSelected ? "bg-blue-50" : ""
														}
														key={contribution.id}
													>
														<TableCell>
															<Checkbox
																...
																disabled={updateContributions.isPending}
																onCheckedChange={() =>
																	handleContributionToggle(contribution)
																}
															/>
														</TableCell>
														<TableCell>
