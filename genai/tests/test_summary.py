...
class TestSummaryService:
    ...
    @pytest.mark.asyncio
    async def test_generate_summary_with_contributions(
        self,
        summary_service,
    ...
    @pytest.mark.asyncio
    async def test_generate_summary_stream_with_contributions(
        self,
        summary_service,
        mock_ingestion_service,
        sample_contributions,
    ...
    @pytest.mark.asyncio
    async def test_progress_report_structure(
        self,
        summary_service,
        mock_ingestion_service,
        sample_contributions,
        ...
        progress_report = await summary_service._generate_progress_report(
            "testuser", "2024-W21", sample_contributions, summary_request
        )
