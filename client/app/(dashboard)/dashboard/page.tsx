...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (contributionsData?.content) {
      ...
      const avgResponseHours = prCount > 0 ? (totalResponseTime / prCount).toFixed(1) : "2.4";
            ...
            <CardContent>
              {isLoading ? (
                ...
                <>
                  ...
                  <p className="text-xs text-muted-foreground">From all contributions</p>
                </>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              {isLoading ? (
                ...
                <>
                  <div className="text-2xl font-bold">{stats.weeklyCommits}</div>
          ...
          <div className="space-y-8">
                  ...
                  <div className="flex items-start gap-3 p-3 bg-slate-50 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Database queries and memory management issues identified...
                      </p>
                      <div className="flex items-center gap-2 mt-2">
                        <Badge className="text-xs" variant="secondary">
                          Approved
                        </Badge>
                        <span className="text-xs text-muted-foreground">8 upvotes</span>
                      </div>
                    </div>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>AI-generated summary of your team's progress</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium">Authentication system refactor completed</p>
                      <p className="text-sm text-muted-foreground">3 PRs merged, 2 issues closed</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <Badge variant="outline">In Progress</Badge>
                    <div>
                      <p className="font-medium">API rate limiting implementation</p>
