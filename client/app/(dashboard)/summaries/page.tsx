    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="text-center py-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Error Loading Summaries</h2>
          <p className="text-gray-600 mb-4">There was an error loading the summaries.</p>
                  ...
                  >
                    ...
                    <div className="flex gap-4 text-sm">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="font-medium">{summary.commitsCount || 0}</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <GitPullRequest className="h-4 w-4 text-green-600" />
                        <span className="font-medium">{summary.pullRequestsCount || 0}</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <Bug className="h-4 w-4 text-orange-600" />
                        <span className="font-medium">{summary.issuesCount || 0}</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <Package className="h-4 w-4 text-purple-600" />
                        <span className="font-medium">{summary.releasesCount || 0}</span>
                      </div>
                    </div>
