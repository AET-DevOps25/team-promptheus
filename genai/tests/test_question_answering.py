...
class TestQuestionAnsweringService:
    ...
    async def test_retrieve_relevant_contributions_empty(self, qa_service):
        ...
        request = QuestionRequest(
            question="What was done?", context=QuestionContext(max_evidence_items=5)
        )
    ...
    async def test_full_question_answering_flow(self, qa_service):
        ...
        response = await qa_service.answer_question(
            user="testuser", week="2024-W21", request=request
        )
    ...
    async def test_conversation_context_functionality(self, qa_service):
        ...
        request1 = QuestionRequest(
            question="What commits were made?", context=QuestionContext()
        )
        ...
        request2 = QuestionRequest(
            question="Tell me more about those commits", context=QuestionContext()
        )
