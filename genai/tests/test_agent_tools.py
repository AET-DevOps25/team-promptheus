...
@pytest.mark.asyncio
async def test_search_github_code() -> None:
...
@pytest.mark.asyncio
async def test_search_github_issues() -> None:
...
@pytest.mark.asyncio
async def test_search_github_pull_requests() -> None:
...
@pytest.mark.asyncio
async def test_get_github_file_content() -> None:
...
@pytest.mark.asyncio
async def test_get_commit_details() -> None:
...
@pytest.mark.asyncio
async def test_get_pull_request_details() -> None:
