...
import { Check, Copy, Link as LinkIcon, LogIn } from "lucide-react";
      ...
      <div className="max-w-2xl w-full space-y-8">
        ...
        {isAuthenticated && (
          <Card className="border-green-200 bg-green-50">
            <CardContent className="pt-6">
              ...
              <Button className="mt-3 w-full" onClick={() => router.push("/dashboard")}>
                Go to Dashboard
              </Button>
            </CardContent>
          </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button className="w-full" disabled={!userCode.trim()} onClick={handleLogin}>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Use a direct URL to automatically log in users</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label>URL Format</Label>
              <div className="flex items-center gap-2">
                <Input className="font-mono text-sm" readOnly value={exampleUrl} />
                <Button
        ...
        <div className="text-center">
          <p className="text-xs text-gray-500">
            Need help? Contact your administrator or check the documentation for your specific user
            code.
          </p>
        </div>
      </div>
